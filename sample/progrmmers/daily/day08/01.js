...
분류: 조건문
문제: 간단한 논리 연산
url: https://school.programmers.co.kr/learn/courses/30/lessons/181917?language=javascript

문제 설명
boolean 변수 x1, x2, x3, x4가 매개변수로 주어질 때, 
다음식의 true/false를 return 하는 solution 함수를 작성해 주세요.

  (x1 ∨ x2) ∧ (x3 ∨ x4)
  x1 ∨ x2 는 x1 또는 x2 중 하나라도 true 이면 true
  x3 ∨ x4 는 x3 또는 x4 중 하나라도 true 이면 true
  두 식 모두 true 이면 true
